    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function generateKodeProduksi() {
                ...
                var day = mulaiProduksi.getDate();
                var month = mulaiProduksi.getMonth() + 1; // Ditambah 1 karena bulan dimulai dari 0
                var year = mulaiProduksi.getFullYear();
...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Edit /</span> Produksi
    </h4>
    <div>
        <div class="card mb-4">
            <h5 class="card-header">Edit Produksi</h5>
            <div class="card-body">
                <form action="{{ route('updateproduction', ['production' => $production->id]) }}" method="POST"
                ...
                <div class="form-floating mb-3">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="nama_product" name="nama_product"
                            value="{{ $production->nama_product }}" placeholder="Description"
                            aria-describedby="floatingInputHelp" />
                        @error('nama_product')
                            <span class="text-danger"> {{ $message }} </span>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" value="{{ $production->mulai_produksi }}"
                            id="mulai_produksi" name="mulai_produksi" />
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" value="{{ $production->exp_date }}" id="exp_date"
                            name="exp_date" />
                        @error('exp_date')
                            <span class="text-danger"> {{ $message }} </span>
                        @enderror
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="jumlah_produksi" name="jumlah_produksi"
                            value="{{ $production->jumlah_produksi }}" placeholder="XXXXX"
                            aria-describedby="floatingInputHelp" />
