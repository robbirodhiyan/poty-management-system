...
@section('content')
    <h4 class="fw-bold py-3 mb-4">
        ...
        <ul class="list-inline mb-0 float-end">
            ...
            <li class="list-inline-item">
                <a href="{{ route('employee.archived') }}" class="btn btn-warning">
                    <i class="bi bi-plus-circle me-1"></i> Archived
                </a>
            </li>
            <li class="list-inline-item">|</li>
            <li class="list-inline-item">
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="{{ route('employee.edit', $item->nip) }}" class="dropdown-item"><i
                                                class="bx bx-edit-alt me-1"></i>
                                            Edit</a>
                                        <form action="{{ route('employee.destroy', $item->nip) }}" method="post" class="delete-btn" data-text="Data karyawan {{$item->name}} akan dihapus">
                                            @method('delete')
                                            @csrf
